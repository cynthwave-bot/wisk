class Heading2Element extends HTMLElement {
    constructor() {
        super();
    ...
    render() {
        ...
        `;
        const content = `<h2 id="editable" contenteditable="${!window.wisk.editor.wiskSite}" spellcheck="false" data-placeholder="${this.placeholder}"></h2>`

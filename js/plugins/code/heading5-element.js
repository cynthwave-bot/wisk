class Heading5Element extends HTMLElement {
    constructor() {
        super();
    ...
    render() {
        ...
        `;
        const content = `<h5 id="editable" contenteditable="${!window.wisk.editor.wiskSite}" spellcheck="false" data-placeholder="${this.placeholder}"></h5>`

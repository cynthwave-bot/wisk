            ...
            <div class="outer" @click=${this.closeDropdown}>
                ...
                <div style="padding: var(--padding-4) calc(var(--padding-4) - var(--padding-3))">
                    <div class="upgrade-to-pro">
                        ...
                        <button class="cancel-button" @click=${() => this.shadowRoot.querySelector('.upgrade-to-pro').style.display = 'none'}>Cancel</button>

    ...
    render() {
        return html`
            ...
            <select id="language-select">
                ${Object.entries(this.supportedLanguages).map(([value, label]) => 
                    html`<option value="${value}" ?selected=${value === this.selectedLang}>${label}</option>`
                )}
            </select>
            <div id="editor"></div>
        `;
